    ...
    <button class="btn-icon" onClick={toggleTheme} title="Schimba tema" aria-label="Schimba tema">
      <Switch>
        ...
        <Match when={theme() === "gray"}>
          {/* Rounded square — treci la apple */}
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="5" ry="5"/></svg>
        </Match>
        <Match when={theme() === "apple"}>
          {/* Sun — treci la light */}
