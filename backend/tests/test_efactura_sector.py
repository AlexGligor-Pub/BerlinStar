...
"""
from app.efactura.mapping import _parse_county_city, normalize_county_code, normalize_ro_b_city
...
if __name__ == "__main__":
    ...
    print(
        f"OK — {len(CITY_CASES)} city + {len(COUNTY_CASES)} judet + {len(PARSE_CASES)} parse trecute."
    )
